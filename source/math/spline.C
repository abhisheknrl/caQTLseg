...
//
{
  ...
  u = dvec_uniform ( n-1, 0.0, 1.0, seed );
  v = dvec_uniform ( n,   0.0, 1.0, seed );
  w = dvec_uniform ( n-1, 0.0, 1.0, seed );
...
//
    else
    {
      ...
      w1 = ( hsum + h1 ) / hsumt3;
      w2 = ( hsum + h2 ) / hsumt3;
      dmax = d_max ( fabs ( del1 ), fabs ( del2 ) );
      dmin = d_min ( fabs ( del1 ), fabs ( del2 ) );
      drat1 = del1 / dmax;
      drat2 = del2 / dmax;
