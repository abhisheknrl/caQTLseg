/*******************************************************************************
 *
 *   DrawXP.h -- Drawing functions used in menuxp.cpp
 *
 *   Björn Nilsson, Sketchware, 2002
 *	 Based on freeware example from codeproject.com.
 */
...
public:
    ...
    void SetRect (LPCRECT pRect) { m_Rect = pRect; }
