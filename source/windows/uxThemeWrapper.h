/*******************************************************************************
 *
 *   uxThemeWrapper.h -- Windows XP theme wrapper.
 *
 *   Björn Nilsson, Sketchware HB, July 2003
 *	 Based on original (dll) code by Pierre ARNAUD, 
 *		OPaC bright ideas, Switzerland. Freeware.
 *
 */
...
/* 
	The original version was a DLL (VisualStylesXP was 
	hidden in the cpp file)	with the following exports:

#if	defined(UXTHEMEWRAPPER_IMPLEMENTATION)
#	define	UXTHEMEWRAPPER_DLL	__declspec (dllexport)
#else
#	define	UXTHEMEWRAPPER_DLL	__declspec (dllimport)
#endif

extern "C" UXTHEMEWRAPPER_DLL bool __stdcall Themes_IsAppThemed ();
extern "C" UXTHEMEWRAPPER_DLL bool __stdcall Themes_DrawBackground (const wchar_t* name, const wchar_t* part, const wchar_t* state, void* hdc, int ox, int oy, int dx, int dy, int clip_ox, int clip_oy, int clip_dx, int clip_dy);
extern "C" UXTHEMEWRAPPER_DLL bool __stdcall Themes_DrawThemeParentBackground (void* hwnd, void* hdc);
extern "C" UXTHEMEWRAPPER_DLL bool __stdcall Themes_DrawThemeParentBackgroundRect (void* hwnd, void* hdc, int ox, int oy, int dx, int dy);
extern "C" UXTHEMEWRAPPER_DLL bool __stdcall Themes_GetTextColor (const wchar_t* name, const wchar_t* part, const wchar_t* state, int* r, int* g, int* b);
*/

// No longer a dll. /bn
bool __stdcall Themes_IsAppThemed ();
bool __stdcall Themes_DrawBackground (const wchar_t* name, const wchar_t* part, const wchar_t* state, void* hdc, int ox, int oy, int dx, int dy, int clip_ox, int clip_oy, int clip_dx, int clip_dy);
...
bool __stdcall Themes_GetTextColor (const wchar_t* name, const wchar_t* part, const wchar_t* state, int* r, int* g, int* b);

extern VisualStylesXP xpStyle;